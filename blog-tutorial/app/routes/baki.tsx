...
export default function Index() {
  ...
  const images = [
    {
      src: "https://chie-pctr.c.yimg.jp/dk/iwiz-chie/que-11223750721?w=450&h=400&up=0",
      alt: "Fly.io",
    },
      ...
      <div className="relative sm:pb-16 sm:pt-8">
        ...
        <div className="mx-auto max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
          <div className="mt-6 flex-wrap justify-center gap-8">
            <a style={{ fontSize: "2rem", color: "red" }}>3千円</a> 
            <a >/敷金: - 礼金:- 保証金: - 敷引・償却: -</a>
            <br/>☆☆☆☆★
            {images.map((image, index) => (
              <img key={index} src={image.src} alt={image.alt} />
            ))}
            所在地：<a href="https://www.navitime.co.jp/address/07202005000/%E7%A6%8F%E5%B3%B6%E7%9C%8C%E4%BC%9A%E6%B4%A5%E8%8B%A5%E6%9D%BE%E5%B8%82%E4%B8%80%E7%AE%95%E7%94%BA%E5%A4%A7%E5%AD%97%E4%BA%80%E8%B3%80/">福島県会津若松市一箕町以下不明</a>
            <br />駅徒歩：ＪＲ磐越西線/会津若松駅 水上走りで5分(※烈海王調べ)
            <br/>間取り:3LDK 面積:20畳
            <br/>築年数:築75年 階:1階
            <br/>建物種別：廃屋
          </div>
